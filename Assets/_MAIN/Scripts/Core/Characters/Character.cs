...
namespace CHARACTERS
{
    public abstract class Character
    {
        ...
        protected Color displayColor => highlighted ? highlightedColor : unhighlightColor;
        protected Color highlightedColor => color;
        protected Color unhighlightColor => new Color(color.r * UNHIGHLIGHTED_DARKEN_STRENGH, color.g * UNHIGHLIGHTED_DARKEN_STRENGH, color.b * UNHIGHLIGHTED_DARKEN_STRENGH, color.a);
        ...
        public void UpdateTextCostomizationsOnScreen() => dialogueSystem.ApplySpeakerDataToDialogueContainer(config);
        ...
        {
            Debug.Log("Flipping is not available on this type of character!");
            yield return null;
        }
